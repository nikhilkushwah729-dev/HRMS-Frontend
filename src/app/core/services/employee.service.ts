...
export class EmployeeService {
    ...
    private normalizeEmployee(raw: any): User {
        ...
        return {
            ...
            shiftId: Number(raw?.shiftId ?? raw?.shift_id ?? 0) || undefined,
            shiftName: raw?.shiftName ?? raw?.shift_name ?? (raw?.shiftId === 2 ? 'Evening Shift' : raw?.shiftId === 3 ? 'Night Shift' : 'General Shift'),
            shiftTiming: raw?.shiftTiming ?? raw?.shift_timing ?? (raw?.shiftId === 2 ? '02:00 PM - 10:00 PM' : raw?.shiftId === 3 ? '10:00 PM - 06:00 AM' : '09:00 AM - 05:00 PM'),
