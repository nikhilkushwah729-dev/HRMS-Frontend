...
@Component({
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-1 space-y-6">
            <div class="card p-6 border-slate-200">
              <h3
                class="text-sm font-black text-slate-900 uppercase tracking-widest mb-6 flex items-center gap-2"
              >
              ...
              <div class="space-y-4">
                ...
                >
                  <span class="text-xs font-bold text-slate-400"
                    >{{ selectedEmployeeIds().size }} selected</span
                  >
                  <button
                    (click)="selectedEmployeeIds().clear()"
            ...
            <div class="card p-6 border-slate-200 bg-slate-900 text-white">
              <h3
                class="text-xs font-black uppercase tracking-widest mb-2 opacity-80"
              >
                Bulk Import
              </h3>
          ...
          <div class="lg:col-span-2">
            <form
              ...
              (ngSubmit)="submitRoster()"
              class="card p-8 border-slate-200 space-y-8"
            >
              <h3
                class="text-base font-black text-slate-900 tracking-tight flex items-center gap-3"
              >
                <div
              ...
              <div formArrayName="assignedShifts" class="space-y-6">
                @for (
                  item of assignedShifts.controls;
                  track i;
                  let i = $index
                ) {
                  <div
                    [formGroupName]="i"
                    class="p-6 rounded-md border border-slate-100 bg-slate-50/50 relative group"
                  >
                    <button
                      type="button"
                      (click)="removeShift(i)"
              ...
              <div
                class="flex flex-col sm:flex-row justify-between items-center gap-6 pt-6 border-t border-slate-100"
              >
                <button
                  type="button"
                  (click)="addShift()"
                ...
                <div class="flex items-center gap-3 w-full sm:w-auto">
                  <button
                    type="button"
                    (click)="resetForm()"
                    class="flex-1 sm:flex-none px-6 py-2.5 rounded-md text-sm font-bold text-slate-500 hover:bg-slate-50 transition-all"
                  >
                    Reset
                  </button>
                  <button
  ...
  styles: [
    `
      ...
      .card {
        @apply bg-white rounded-md shadow-sm border border-slate-100;
      }
    `,
  ],
})
