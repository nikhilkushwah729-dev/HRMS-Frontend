      ...
      <section class="app-module-hero">
        <div>
          ...
          <p class="app-module-text max-w-2xl">
            Create department records, keep parent structure visible, and
            maintain cleaner organization masters for employees and admin flows.
          </p>
        </div>
        <div class="app-module-highlight">
          ...
          <p class="mt-2 text-sm text-slate-600">
            Filtered results: {{ filteredDepartments().length }}
          </p>
        </div>
      </section>
