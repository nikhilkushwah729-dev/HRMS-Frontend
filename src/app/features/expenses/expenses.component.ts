  ...
  template: `
    <div class="flex flex-col gap-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div
          class="bg-white rounded-md border border-slate-100 p-6 flex items-center gap-4"
        >
          <div
            class="w-12 h-12 bg-yellow-50 rounded-md flex items-center justify-center text-yellow-500"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="22"
        ...
        >
          <div
            class="w-12 h-12 bg-green-50 rounded-md flex items-center justify-center text-green-500"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="22"
        ...
        >
          <div
            class="w-12 h-12 bg-primary-50 rounded-md flex items-center justify-center text-primary-600"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="22"
                ...
                <tr class="hover:bg-slate-50/50 transition-colors group">
                  ...
                  <td class="px-6 py-4">
                    <span class="text-xs font-medium text-slate-500">{{
                      expense.expenseDate || expense.date | date: 'mediumDate'
                    }}</span>
                  </td>
                  <td class="px-6 py-4">
                    @if (expense.status === 'pending') {
                      <span
                        class="inline-flex items-center gap-1.5 text-xs font-semibold text-amber-600 bg-amber-50 px-2.5 py-1 rounded-full"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="10"
...
export class ExpensesComponent implements OnInit {
  ...
  myExpenses(): any[] {
    ...
    return this.expenses().filter(
      (e) => e.employeeId === uid || e.employee_id === uid,
    );
  }
        ...
        this.expenses.set([
          {
            id: 1,
            employeeId: uid,
            title: 'Client Lunch - Tech Project',
            amount: 3500,
            category: 'meals',
            expenseDate: '2025-03-24',
            status: 'pending',
            description: 'Business discussion with Alpha Tech team.',
          },
          {
            id: 2,
            employeeId: uid,
            title: 'Monthly Internet Reimbursement',
            amount: 1500,
            category: 'other',
          ...
          },
          {
            id: 4,
            employeeId: 999,
            employee: { firstName: 'Rohan Sharma', fullName: 'Rohan Sharma' },
            title: 'Flight to Mumbai - Site Visit',
            amount: 12400,
            category: 'travel',
            expenseDate: '2025-03-24',
            status: 'pending',
            description: 'Site inspection for North Zone project.',
          },
          {
            id: 5,
            employeeId: 998,
            employee: { firstName: 'Priya Verma', fullName: 'Priya Verma' },
            title: 'New Keyboard & Mouse',
            amount: 2200,
            category: 'office_supplies',
            expenseDate: '2025-03-23',
            status: 'pending',
            description: 'Hardware replacement for Design team.',
          },
        ]);
        this.updateSummary();
        this.loading.set(false);
  ...
  private updateSummary() {
    ...
    this.myPendingTotal.set(
      mine
        .filter((e) => e.status === 'pending')
        .reduce((s, e) => s + e.amount, 0),
    );
    this.myApprovedTotal.set(
      mine
