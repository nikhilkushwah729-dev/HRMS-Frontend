...
@Component({
  ...
  template: `
    <div class="space-y-6 p-1">
        ...
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-slate-200">
            ...
            <tbody class="divide-y divide-slate-100 bg-white">
              <tr
                *ngFor="let req of regularizations"
              ...
              >
                ...
                <td class="whitespace-nowrap px-6 py-4 text-sm">
                  <button
                    *ngIf="req.status === 'pending' && isAdmin"
      ...
      <div
        *ngIf="!loading && regularizations.length > 0"
    ...
    >
      <div
        class="w-full max-w-md overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-2xl"
      >
        ...
        <div class="p-6">
          <div class="space-y-4">
            <div>
              ...
              <input
                type="date"
                [(ngModel)]="formData.regularizationDate"
                required
                class="w-full rounded-md border border-slate-300 px-4 py-3 focus:border-slate-900 focus:outline-none focus:ring-4 focus:ring-slate-200"
              />
            </div>
