  ...
  template: `
    <div class="flex h-full flex-col overflow-hidden rounded-md bg-white shadow-sm ring-1 ring-slate-100 transition-all hover:shadow-2xl hover:shadow-slate-200/40">
      <div class="flex flex-col shrink-0 gap-4 p-8 border-b border-slate-50 bg-slate-50/20 sm:flex-row sm:items-center justify-between">
        ...
        <button
          (click)="viewAll.emit()"
          class="rounded-md bg-slate-100 px-6 py-2.5 text-[11px] font-black uppercase tracking-widest text-slate-600 transition-all hover:bg-emerald-50 hover:text-emerald-600"
        >
              ...
              <tr class="group transition-all hover:bg-slate-50/50">
                <td class="px-8 py-5">
                  <div class="flex items-center gap-4">
                    <div class="flex h-10 w-10 items-center justify-center rounded-md bg-white shadow-sm text-slate-400 transition-all group-hover:bg-emerald-50 group-hover:text-emerald-600 ring-1 ring-slate-100">
                ...
                <td class="px-8 py-5">
                   <div class="inline-flex items-center rounded-md bg-slate-100 px-3 py-1 text-xs font-black text-slate-900">
                      {{ req.totalDays }} Days
                   </div>
                </td>
                <td class="px-8 py-5">
                  <div class="flex justify-center">
                    <span
                      class="px-4 py-1.5 rounded-md text-[10px] font-black uppercase tracking-widest border"
                      [ngClass]="{
              ...
              <tr>
                <td colspan="4" class="py-20 text-center">
                   <div class="flex flex-col items-center gap-3">
                      <div class="flex h-16 w-16 items-center justify-center rounded-md bg-slate-50 text-slate-300">
