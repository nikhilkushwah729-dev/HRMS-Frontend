    ...
    <div class="flex h-full flex-col overflow-hidden rounded-md bg-white shadow-sm ring-1 ring-slate-200">
      <div class="flex flex-col gap-4 border-b border-slate-100 px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
        <div class="flex items-center gap-4">
           <div class="flex h-10 w-10 items-center justify-center rounded-md bg-slate-50 text-emerald-600">
      ...
      <div class="flex flex-1 flex-col gap-4 p-4 sm:p-5">
        <div class="rounded-md border border-slate-200 bg-slate-50 p-5">
          <div class="flex items-start justify-between gap-3">
            ...
            <div class="flex h-14 w-14 shrink-0 items-center justify-center rounded-md"
        ...
        <div class="grid grid-cols-2 gap-3">
          <div class="rounded-md border border-emerald-200 bg-emerald-50 px-4 py-4">
