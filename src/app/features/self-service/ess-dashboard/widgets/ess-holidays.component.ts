      ...
      <div class="flex-1 p-8 overflow-y-auto custom-scrollbar">
        <div class="space-y-3">
          @for (holiday of holidays(); track holiday.date) {
            <div class="group flex items-center justify-between rounded-md bg-slate-50 p-5 transition-all hover:bg-white hover:shadow-xl hover:shadow-slate-200/40 ring-1 ring-transparent hover:ring-slate-100">
              <div class="flex items-center gap-4">
                <div class="h-10 w-10 flex items-center justify-center rounded-md bg-white shadow-sm text-emerald-600 transition-transform group-hover:scale-110">
              ...
              <div class="rounded-md bg-white px-4 py-2 text-[10px] font-black uppercase tracking-widest text-emerald-600 shadow-sm ring-1 ring-slate-100 group-hover:bg-slate-900 group-hover:text-white group-hover:ring-slate-900 transition-all">
