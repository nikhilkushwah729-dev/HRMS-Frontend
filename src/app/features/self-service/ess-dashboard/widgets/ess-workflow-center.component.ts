          ...
          @for (workflow of workflows(); track workflow.key) {
            ...
            >
              <div class="flex w-full items-start justify-between">
                 ...
                 <span class="ml-4 rounded-md bg-white px-4 py-1.5 text-[10px] font-black uppercase tracking-widest text-slate-400 shadow-sm ring-1 ring-slate-100">
                    {{ workflow.badge }}
                 </span>
              </div>
              ...
              <div class="mt-6 flex w-full items-center justify-between border-t border-slate-200/50 pt-4 opacity-0 group-hover:opacity-100 transition-opacity">
                 ...
                 <div class="h-8 w-8 flex items-center justify-center rounded-md bg-slate-900 text-white shadow-lg transition-transform group-hover:scale-110">
