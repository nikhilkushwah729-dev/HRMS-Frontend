          ...
          <section class="app-surface-card p-5 sm:p-6">
            ...
            <div class="mb-5 rounded-md border border-dashed border-slate-300 p-4 text-center bg-slate-50/50 hover:bg-slate-50 transition-colors">
              <div class="flex flex-col items-center justify-center gap-3">
                @if (avatarPreview()) {
                  <div class="relative">
                    <img [src]="avatarPreview()" alt="Avatar Preview" class="h-20 w-20 rounded-full object-cover border-2 border-blue-500 shadow-md">
                ...
                <div>
                  <label class="cursor-pointer text-xs font-bold text-blue-600 hover:text-blue-700">
