...
-- SEED DATA
INSERT IGNORE INTO roles (id, name) VALUES (1, 'Super Admin'), (2, 'Admin'), (3, 'HR'), (4, 'Employee');
INSERT IGNORE INTO leave_types (type_name, type_code, days_per_year, is_paid, color) VALUES 
('Annual Leave', 'AL', 20, 1, '#22C55E'),
('Sick Leave', 'SL', 10, 1, '#EF4444'),
('Casual Leave', 'CL', 5, 1, '#3B82F6');
INSERT IGNORE INTO shifts (name, start_time, end_time) VALUES ('General', '09:00:00', '18:00:00');
INSERT IGNORE INTO users (email, password, first_name, last_name, role_id, employee_code, status) VALUES 
('admin@company.com', '$2a$10$xGJ9Q7K5Y8F3R4P6L8N0O.1cE9D2F3G4H5I6J7K8L9M0N1O2P', 'Super', 'Admin', 1, 'EMP001', 'active');
INSERT IGNORE INTO plans (name, price_monthly, max_employees) VALUES ('Free', 0, 10), ('Pro', 29, 100), ('Enterprise', 99, 999999);
